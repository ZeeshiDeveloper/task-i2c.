...
const Footer: React.FC<IFooter> = () => {
	...
	return (
		<div
			...
			style={{ margin: "0 3rem", borderTop: "1px solid #CBCBCB" ,paddingBottom:"1rem"}}
		>
			<Grid container sx={{ mt: "2rem", pb: "2rem" }}>
				...
				<Grid item lg={6} xl={6} md={6} sm={12} xs={12}>
					<Box
						sx={{ display: { xs: "grid", md: "flex" }, justifyContent: "end" }}
					>
			...
			<small style={{textAlign:"left"}}>Copyright © 2023 i2c inc. All rights reserved.</small>
		</div>
	);
};
