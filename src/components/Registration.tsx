import { Avatar, Backdrop, Box, Card, CircularProgress, Grid, Typography,useMediaQuery, useTheme } from '@mui/material'
  ...
  return (
    ...
    <div>
        ...
        <Grid item lg={6} xl={6} md={6} sm={12} xs={12}>
            <img src={registrationImage} alt="about us" style={{maxWidth:"100%", height:"auto"}} />
        </Grid>
        <Grid item lg={6} xl={6} md={6} sm={12} xs={12} sx={{display:"flex",alignItems:"center"}}>
		{isSubmitted ? (
			<Box>
