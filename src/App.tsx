...
function App() {
  ...
  const theme = useTheme();
	...
	const padding = isExtraSmallScreen ? '1rem' : isSmallScreen ? '5rem' : isMediumScreen ? "3rem" : isLargeScreen ? "4rem" : '1.5rem 200px';
  ...
  return (
    <div style={{backgroundImage:`url(${background})`,backgroundColor:"#eff7ff"}}>
      <Navigation
